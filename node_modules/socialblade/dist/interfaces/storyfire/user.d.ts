import { Data, Daily, Misc, Statistics, UserGeneral, Id, SmallBranding, GrowthNumbers } from '../matrix.shared';
...
export interface StoryFireUser extends Data<Id, StoryFireUserGeneral, StoryFireStatistics, StoryFireRanks> {
    misc: Misc;
