import { Data, Daily, Misc, Statistics, UserGeneral, SmallBranding, ExtendedId, GrowthNumbers } from '../matrix.shared';
import { TrovoGeneral, TrovoRanks, TrovoTotal } from './shared';
export type TrovoUserGeneral = TrovoGeneral & UserGeneral<SmallBranding>;
export interface TrovoUser extends Data<ExtendedId, TrovoUserGeneral, TrovoStatistics, TrovoRanks> {
    misc: TrovoMisc;
    daily: TrovoDaily[];
}
