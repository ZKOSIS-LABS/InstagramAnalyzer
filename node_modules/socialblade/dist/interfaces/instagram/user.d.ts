import { Daily, Data, ExtendedId, GrowthNumbers, Misc, Statistics, UserGeneral } from '../matrix.shared';
...
export interface InstagramUser extends Data<ExtendedId, InstagramUserGeneral, InstagramStatistics, InstagramRanks> {
    misc: Misc;
