import { Data, Daily, Misc, ExtendedId, Branding, Statistics, UserGeneral, GrowthNumbers } from '../matrix.shared';
...
export interface TwitterUser extends Data<ExtendedId, TwitterUserGeneral, TwitterStatistics, TwitterRanks> {
    misc: TwitterMisc;
    daily: TwitterDaily[];
}
