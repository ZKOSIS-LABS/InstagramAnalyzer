import { Data, Daily, Misc, Statistics, UserGeneral, ExtendedId, GrowthNumbers } from '../matrix.shared';
import { FacebookRanks, FacebookTotal } from './shared';
export type FacebookUserGeneral = UserGeneral;
export interface FacebookUser extends Data<ExtendedId, FacebookUserGeneral, FacebookStatistics, FacebookRanks> {
    misc: Misc;
    daily: FacebookDaily[];
}
