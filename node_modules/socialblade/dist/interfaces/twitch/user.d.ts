import { Data, Daily, Misc, Statistics, Branding, UserGeneral, ExtendedId, GrowthNumbers } from '../matrix.shared';
import { TwitchGeneral, TwitchRanks, TwitchTotal } from './shared';
export type TwitchUserGeneral = TwitchGeneral & UserGeneral<Branding>;
export interface TwitchUser extends Data<ExtendedId, TwitchUserGeneral, TwitchStatistics, TwitchRanks> {
    misc: TwitchMisc;
    daily: TwitchDaily[];
}
